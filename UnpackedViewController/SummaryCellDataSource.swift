...
struct SummaryCellDataSource {
    ...
    static func browseSummaryFromUser(user: User)
        -> SummaryCellDataSource {
        return SummaryCellDataSource(
            totalBalance: user.totalBalance,
            details: .Subtitle(text: user.displayAccountsCount))
    }
    ...
    static func fromAccount(account: Account)
        -> SummaryCellDataSource {
        return SummaryCellDataSource(
            totalBalance: account.balance,
            details: .Button(title: "Rollover"))
    }
}
